...
class BanditParametersResponseDeserializerTest {
  ...
  public void testDeserializingBandits() throws IOException {
    ...
    Map<String, BanditNumericAttributeCoefficients> nikeSubjectNumericCoefficients =
        nikeCoefficients.getSubjectNumericCoefficients();
    assertEquals(1, nikeSubjectNumericCoefficients.size());

    BanditNumericAttributeCoefficients nikeAccountAgeCoefficients =
        nikeSubjectNumericCoefficients.get("account_age");
    ...
    Map<String, BanditCategoricalAttributeCoefficients> nikeSubjectCategoricalCoefficients =
        nikeCoefficients.getSubjectCategoricalCoefficients();
    assertEquals(1, nikeSubjectCategoricalCoefficients.size());

    BanditCategoricalAttributeCoefficients nikeGenderIdentityCoefficients =
        nikeSubjectCategoricalCoefficients.get("gender_identity");
    ...
    Map<String, Double> nikeGenderIdentityCoefficientValues =
        nikeGenderIdentityCoefficients.getValueCoefficients();
    ...
    Map<String, BanditNumericAttributeCoefficients> nikeActionNumericCoefficients =
        nikeCoefficients.getActionNumericCoefficients();
    assertEquals(1, nikeActionNumericCoefficients.size());

    BanditNumericAttributeCoefficients nikeBrandAffinityCoefficient =
        nikeActionNumericCoefficients.get("brand_affinity");
    ...
    Map<String, BanditCategoricalAttributeCoefficients> nikeActionCategoricalCoefficients =
        nikeCoefficients.getActionCategoricalCoefficients();
    assertEquals(1, nikeActionCategoricalCoefficients.size());

    BanditCategoricalAttributeCoefficients nikeLoyaltyCoefficients =
        nikeActionCategoricalCoefficients.get("loyalty_tier");
    ...
    Map<String, Double> nikeLoyaltyCoefficientValues =
        nikeLoyaltyCoefficients.getValueCoefficients();
    ...
    Map<String, BanditNumericAttributeCoefficients> adidasSubjectNumericCoefficients =
        adidasCoefficients.getSubjectNumericCoefficients();
    assertEquals(0, adidasSubjectNumericCoefficients.size());

    Map<String, BanditCategoricalAttributeCoefficients> adidasSubjectCategoricalCoefficients =
        adidasCoefficients.getSubjectCategoricalCoefficients();
    assertEquals(1, adidasSubjectCategoricalCoefficients.size());

    BanditCategoricalAttributeCoefficients adidasGenderIdentityCoefficient =
        adidasSubjectCategoricalCoefficients.get("gender_identity");
    ...
    Map<String, Double> adidasGenderIdentityCoefficientValues =
        adidasGenderIdentityCoefficient.getValueCoefficients();
    ...
    Map<String, BanditNumericAttributeCoefficients> adidasActionNumericCoefficients =
        adidasCoefficients.getActionNumericCoefficients();
    assertEquals(1, nikeActionNumericCoefficients.size());

    BanditNumericAttributeCoefficients adidasBrandAffinityCoefficient =
        adidasActionNumericCoefficients.get("brand_affinity");
    ...
    Map<String, BanditCategoricalAttributeCoefficients> adidasActionCategoricalCoefficients =
        adidasCoefficients.getActionCategoricalCoefficients();
    assertEquals(1, adidasActionCategoricalCoefficients.size());

    BanditCategoricalAttributeCoefficients adidasPurchasedLast30Coefficient =
        adidasActionCategoricalCoefficients.get("purchased_last_30_days");
    ...
    Map<String, Double> adidasPurchasedLast30CoefficientValues =
        adidasPurchasedLast30Coefficient.getValueCoefficients();
