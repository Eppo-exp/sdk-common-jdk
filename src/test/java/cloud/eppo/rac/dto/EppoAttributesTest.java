...
class EppoAttributesTest {
  ...
  void testSerializeEppoAttributesToJSONString() throws JSONException {
    ...
    String expectedJson =
        "{ \"boolean\": false, \"number\": 1.234, \"string\": \"hello\", \"null\": null }";
  ...
  void testSerializeNumericAttributesToJSONString() throws JSONException {
    ...
    String expectedJson =
        "{ \"positive\": 12.3, \"negative\": -45.6, \"integer\": 43, \"null\": null }";
  ...
  void testSerializeCategoricalAttributesToJSONString() throws JSONException {
    ...
    String serializedJSONString =
        EppoAttributes.serializeAttributesToJSONString(categoricalAttributes);
    ...
    serializedJSONString =
        EppoAttributes.serializeNonNullAttributesToJSONString(categoricalAttributes);
